 ...
 */
class MApiMobileCommentsController extends BaseController
{
    /**
     * @var MApiMobileCommentsController The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return MApiMobileCommentsController The *Singleton* instance.
     */
     ...
     *
     * @param Models\MRequest $body TODO: type description here
    ...
    public function m(
        ...
        $_queryBuilder = '/api/mobile/comments/read';
